 ...
 * @author bhaidu
 */
public class BladeLexerUtils extends TestCase {
    
    public static class LexerResultItem {
        private BladeTokenId tokenId;
        private String text;

        public LexerResultItem(BladeTokenId tokenId, String text) {
         ...
         * @return the tokenId
         */
        public BladeTokenId getTokenId() {
            return tokenId;
        }
    ...
    public static void next(TokenSequence<?> ts, TokenId id, String fixedText) {
        ...
        assertEquals(BladeTokenId.T_HTML, id);
        ...
        while (line != null) {
            if (line.startsWith("#->[")) {
                ...
                if (index > 0) {
                    ...
                    resultItem = new LexerResultItem(BladeTokenId.valueOf(tokenIdName), text);
