...
public class BladeAntlrFormatterLexer extends LexerAdaptor {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SG_QUOTE", "DB_QUOTE", "HTML_CLOSE_TAG", "GT_SYMBOL", "D_PHP", "AT", 
			"WS", "NL", "OTHER", "D_ARG_LPAREN", "D_ARG_RPAREN", "D_ARG_NL", "PHP_EXPR", 
			"EXIT_EOF", "D_ENDPHP", "PHP_CODE_GREEDY", "PHP_CODE_COMPLETION"
		};
	}
