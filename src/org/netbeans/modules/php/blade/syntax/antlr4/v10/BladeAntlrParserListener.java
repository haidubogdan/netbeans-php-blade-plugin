...
public interface BladeAntlrParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BladeAntlrParser#blockSection}.
	 * @param ctx the parse tree
	 */
	void enterBlockSection(BladeAntlrParser.BlockSectionContext ctx);
	/**
	 * Exit a parse tree produced by {@link BladeAntlrParser#blockSection}.
	 * @param ctx the parse tree
	 */
	void exitBlockSection(BladeAntlrParser.BlockSectionContext ctx);
	/**
	 * Enter a parse tree produced by {@link BladeAntlrParser#blockPush}.
	 * @param ctx the parse tree
	 */
	void enterBlockPush(BladeAntlrParser.BlockPushContext ctx);
	/**
	 * Exit a parse tree produced by {@link BladeAntlrParser#blockPush}.
	 * @param ctx the parse tree
	 */
	void exitBlockPush(BladeAntlrParser.BlockPushContext ctx);
	/**
	 * Enter a parse tree produced by {@link BladeAntlrParser#inlineSection}.
	 * @param ctx the parse tree
	 */
	void enterInlineSection(BladeAntlrParser.InlineSectionContext ctx);
	/**
	 * Exit a parse tree produced by {@link BladeAntlrParser#inlineSection}.
	 * @param ctx the parse tree
	 */
	void exitInlineSection(BladeAntlrParser.InlineSectionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link BladeAntlrParser#unclosedDirectives}.
	 * @param ctx the parse tree
	 */
	void enterUnclosedDirectives(BladeAntlrParser.UnclosedDirectivesContext ctx);
	/**
	 * Exit a parse tree produced by {@link BladeAntlrParser#unclosedDirectives}.
	 * @param ctx the parse tree
	 */
	void exitUnclosedDirectives(BladeAntlrParser.UnclosedDirectivesContext ctx);
	/**
