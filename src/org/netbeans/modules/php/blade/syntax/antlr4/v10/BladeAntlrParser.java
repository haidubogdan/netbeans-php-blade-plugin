...
public class BladeAntlrParser extends Parser {
	...
	public static final int
		...
		PHP_INLINE_START=112, HTML_COMPONENT_PREFIX=113, BLADE_COMMENT_START=114, 
		CONTENT_TAG_CLOSE=115, RAW_TAG_CLOSE=116, WS_EXPR_ESCAPE=117, WS_EXPR=118, 
		WS_COMPOSED_EXPR=119, EXPR_STRING=120, COMPOSED_EXPR_RPAREN=121, WS_BL_PARAM=122, 
		FOREACH_WS_EXPR=123, FOREACH_LOOP_LPAREN=124, FOREACH_LOOP_RPAREN=125, 
		FOREACH_AS=126, FOREACH_PARAM_ASSIGN=127, BL_PARAM_LINE_COMMENT=128, BL_SQ_RPAREN=129, 
		BL_PARAM_RPAREN=130, BL_PARAM_CONCAT_OPERATOR=131, BL_COMMA_EL=132, BL_PARAM_WS=133, 
		BL_NAME_STRING=134, PHP_D_BLADE_COMMENT=135, PHP_D_BLADE_ML_COMMENT=136, 
		D_ENDPHP=137, PHP_EXIT=138, PHP_INLINE_COMMENT=139, PHP_INLINE_ML_COMMENT=140, 
		BLADE_COMMENT_END=141, AT=142, RAW_TAG_START=143, REGULAR_ECHO_STATIC_ACCESS=144, 
		REGULAR_ECHO_LPAREN=145, REGULAR_ECHO_RPAREN=146, REGULAR_ECHO_INSTANCE_ACCESS=147, 
		PHP_D_EXPR_CURLY_LPAREN=148, PHP_D_EXPR_CURLY_RPAREN=149, PHP_D_CLASS=150, 
		PHP_D_WS=151;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"RAW_TAG_OPEN", "PHP_INLINE_START", "HTML_COMPONENT_PREFIX", "BLADE_COMMENT_START", 
			...
			"REGULAR_ECHO_INSTANCE_ACCESS", "PHP_D_EXPR_CURLY_LPAREN", "PHP_D_EXPR_CURLY_RPAREN", 
			"PHP_D_CLASS", "PHP_D_WS"
		};
	}
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1729335346690260992L) != 0 || (((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 561846068566573L) != 0) {
				{
				{
				setState(158);
				general_statement();
	...
	public final SectionContext section() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 4035178355903954944L) != 0 || (((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 561846068566573L) != 0) {
				{
				setState(269);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
			...
			case 2:
				...
				do {
					...
					case 1:
						...
						setState(699);
						_la = _input.LA(1);
						if ( !(_la==PHP_EXPRESSION || _la==PHP_VARIABLE || (((_la - 124)) & ~0x3f) == 0 && ((1L << (_la - 124)) & 15L) != 0) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final SingleArgWrapperNovarContext singleArgWrapperNovar() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 2951180L) != 0 || (((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 13L) != 0) {
				{
				setState(759);
				_errHandler.sync(this);
	...
	public final Verbatim_blockContext verbatim_block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( _la==HTML || _la==PHP_INLINE_START || _la==HTML_COMPONENT_PREFIX );
			setState(909);
			match(D_ENDVERBATIM);
			}
		}
	...
	public static final String _serializedATN =
		...
		"5\u0286\b5\u000b5\f5\u0287\u00015\u00015\u00035\u028c\b5\u00015\u0001"+
		"5\u00055\u0290\b5\n5\f5\u0293\t5\u00015\u00015\u00016\u00016\u00016\u0001"+
		"6\u00017\u00037\u029c\b7\u00017\u00017\u00018\u00038\u02a1\b8\u00018\u0001"+
		"8\u00019\u00019\u00019\u00059\u02a8\b9\n9\f9\u02ab\t9\u00019\u00019\u0001"+
		":\u0001:\u0001:\u0005:\u02b2\b:\n:\f:\u02b5\t:\u0001:\u0001:\u0001;\u0001"+
		";\u0001<\u0001<\u0004<\u02bd\b<\u000b<\f<\u02be\u0003<\u02c1\b<\u0001"+
		"=\u0001=\u0004=\u02c5\b=\u000b=\f=\u02c6\u0001=\u0001=\u0001>\u0001>\u0001"+
		...
		"?\u0003?\u02ec\b?\u0001@\u0001@\u0001@\u0003@\u02f1\b@\u0001@\u0001@\u0001"+
		"A\u0001A\u0001A\u0005A\u02f8\bA\nA\fA\u02fb\tA\u0001A\u0001A\u0001B\u0001"+
		"B\u0001B\u0003B\u0302\bB\u0001B\u0001B\u0003B\u0306\bB\u0001B\u0001B\u0005"+
		"B\u030a\bB\nB\fB\u030d\tB\u0003B\u030f\bB\u0001B\u0001B\u0001C\u0001C"+
		"\u0001C\u0003C\u0316\bC\u0001C\u0001C\u0001C\u0001C\u0001D\u0001D\u0001"+
		"D\u0001D\u0001D\u0003D\u0321\bD\u0001D\u0001D\u0001E\u0001E\u0001E\u0003"+
		"E\u0328\bE\u0001E\u0001E\u0005E\u032c\bE\nE\fE\u032f\tE\u0001E\u0001E"+
		"\u0001F\u0005F\u0334\bF\nF\fF\u0337\tF\u0001F\u0001F\u0005F\u033b\bF\n"+
		"F\fF\u033e\tF\u0001G\u0005G\u0341\bG\nG\fG\u0344\tG\u0001G\u0004G\u0347"+
		"\bG\u000bG\fG\u0348\u0001G\u0005G\u034c\bG\nG\fG\u034f\tG\u0001H\u0001"+
		"H\u0001H\u0001H\u0001H\u0001H\u0001H\u0001H\u0001H\u0001H\u0001H\u0003"+
		"H\u035c\bH\u0001I\u0001I\u0001I\u0001I\u0005I\u0362\bI\nI\fI\u0365\tI"+
		"\u0001I\u0003I\u0368\bI\u0001I\u0001I\u0001J\u0001J\u0004J\u036e\bJ\u000b"+
		"J\fJ\u036f\u0001J\u0001J\u0001J\u0001J\u0003J\u0376\bJ\u0001K\u0001K\u0005"+
		"K\u037a\bK\nK\fK\u037d\tK\u0001K\u0001K\u0005K\u0381\bK\nK\fK\u0384\t"+
		"K\u0001K\u0001K\u0001L\u0001L\u0004L\u038a\bL\u000bL\fL\u038b\u0001L\u0001"+
		"L\u0001M\u0001M\u0003M\u0392\bM\u0001N\u0004N\u0395\bN\u000bN\fN\u0396"+
		"\u0001N\u0003N\u039a\bN\u0001N\u0000\u0000O\u0000\u0002\u0004\u0006\b"+
		"\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e \"$&(*,.02"+
