 ...
 */
package org.netbeans.modules.php.blade.editor.codetemplate;
...
public class BladeCodeTemplateFilter extends UserTask implements CodeTemplateFilter {
    private static final Logger LOGGER = Logger.getLogger(BladeCodeTemplateFilter.class.getName());
    private static final RequestProcessor RP = new RequestProcessor(BladeCodeTemplateFilter.class);
    private volatile boolean accept = true;
    private final Future<Future<Void>> future;
    private final int offset;

    public BladeCodeTemplateFilter(final JTextComponent component, int offset) {
        this.offset = offset;
...
//            }
    ...
    public static final class Factory implements CodeTemplateFilter.Factory {
        ...
        public CodeTemplateFilter createFilter(JTextComponent component, int offset) {
            return new BladeCodeTemplateFilter(component, offset);
        }
