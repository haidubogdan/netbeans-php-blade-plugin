...
public class PluginDirectives {
    ...
    private void initLivewirePlugins() {
        ...
        //flux
        livewirePlugins.add(new PluginDirective("@fluxAppearance")); // NOI18N
        livewirePlugins.add(new PluginDirective("@fluxScripts")); // NOI18N
        pluginDirectives.put("livewire", livewirePlugins); // NOI18N
    }
