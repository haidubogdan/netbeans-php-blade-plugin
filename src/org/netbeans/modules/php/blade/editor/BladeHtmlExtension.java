...
import static org.netbeans.modules.php.blade.editor.BladeLanguage.MIME_TYPE;
...
public class BladeHtmlExtension extends HtmlExtension {
    @Override
    ...
    public boolean isCustomAttribute(Attribute attribute, HtmlSource source) {
        ...
        return attributeName.startsWith(":"); //NOI18N
    }
