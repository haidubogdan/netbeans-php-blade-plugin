...
public class BladeReferenceIdsCollection {
    ...
    public String extractIdentifier(Token identifiableStringToken) {
        String rawReferenceId = identifiableStringToken.getText();
        return EditorStringUtils.stripSurroundingQuotes(rawReferenceId);
    }
    ...
    public void addReferenceId(ReferenceType type, String referenceId, OffsetRange range) {
